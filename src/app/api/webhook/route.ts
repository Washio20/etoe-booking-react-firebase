...
ご予約の変更・キャンセルは、マイページよりお手続きください。
ご予約開始時間の48時間前以降のキャンセルは、理由の如何を問わず、キャンセル料としてご利用料金の100％を頂戴しております。
サウナスイートのご予約につきましては、ご利用日の7日前（168時間前）から2日前（48時間前）までのキャンセルに、キャンセル料50％を頂戴しております。
あらかじめご了承くださいませ。
