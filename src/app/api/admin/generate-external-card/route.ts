...
export async function POST(req: Request) {
  try {
    ...
    const { physicalRoomId, reservationId, startDateTime, endDateTime, userName, userEmail } =
      requestBody;

    // 验证请求参数
    if (!physicalRoomId || !reservationId || !startDateTime || !endDateTime || !userName || !userEmail) {
