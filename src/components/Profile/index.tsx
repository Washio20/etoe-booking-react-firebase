      ...
      <div className="space-y-4 md:space-y-6">
        ...
        <form onSubmit={handleSubmit} className="max-w-2xl mx-auto">
          <div className="space-y-3 md:space-y-4">
            ...
            {/* 性別 */}
            <div className="flex flex-col md:flex-row md:items-center">
              <label className="block text-[#444444] font-zen-kaku-gothic md:w-1/3 text-[12px] md:text-base mb-1 md:mb-0">
                性別
              </label>
          ...
          {/* 状态消息 */}
          {saveSuccess && (
            <div className="mt-4 p-2 bg-emerald-100 text-emerald-700 rounded text-center text-[12px] md:text-base">
              会員情報が正常に更新されました。
            </div>
          )}
          {saveError && (
            <div className="mt-4 p-2 bg-red-100 text-red-800 rounded text-center text-[12px] md:text-base">
              {saveError}
            </div>
          )}
          ...
          <div className="mt-6 md:mt-8 flex justify-center gap-3 md:gap-4">
            {!isEditing ? (
              <button
                ...
                className="px-10 md:px-20 py-2 md:py-3 text-[13px] md:text-sm font-medium text-white bg-gray-700 rounded-full hover:bg-gray-800 w-full md:w-72 whitespace-nowrap"
              >
                編集する
              </button>
            ) : (
              <>
                <button
                  ...
                  className="px-4 md:px-8 py-2 md:py-3 text-[13px] md:text-sm font-medium text-gray-700 bg-gray-200 rounded-full hover:bg-gray-300"
                >
                  キャンセル
                </button>
                <button
                  type="submit"
                  className="px-4 md:px-8 py-2 md:py-3 text-[13px] md:text-sm font-medium text-white bg-gray-700 rounded-full hover:bg-gray-800"
                  disabled={isSaving}
                >
                  {isSaving ? "保存中..." : "保存する"}
                </button>
